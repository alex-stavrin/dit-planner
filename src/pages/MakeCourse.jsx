...
export const MakeCourse = ({onMakeCourse}) => {
  ...
  return (
    <div className="flex items-center gap-5 flex-col w-full h-full mt-5">
      <h1 className="text-3xl font-bold">Make a Course</h1>
      <Card className="w-full sm:w-3/4 md:w-1/3 p-3">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label 
                    htmlFor="ects"
                    className={cn(
                      errors.ects && touched.ects ? "text-destructive" : ""
                    )}
                  >
                    ECTS
                  </Label>
                  <Input
                    ...
                    placeholder="ECTS"
                    className={cn(
                      errors.ects && touched.ects ? "border-destructive" : ""
                    )}
                  />
