...
export function Home({ courses }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center overflow-auto">
      ...
      >
        <CircularProgressLabel className="text-2xl">{ectsPassedSum} ects</CircularProgressLabel>
      </CircularProgress>

      <div className="mb-4 flex w-full flex-col sm:w-3/4 md:w-1/2">
        <Button asChild className="mb-1 h-[65px] rounded-none bg-blue-500 hover:bg-blue-600">
          <RouterLink to="/dit-planner/all">Add Courses</RouterLink>
        </Button>
      </div>

      <Card className="mb-4 w-full sm:w-3/4 md:w-1/2">
        <CardHeader>
        ...
        <CardContent>
          <div className="divide-y">
            <div className="pb-4">
              <h3 className="mb-5 text-xl font-bold">Passed Overview</h3>
              <div className="mb-4">
                ...
                <table className="w-full border-collapse">
                  <thead>
                    <tr>
                      ...
                      <th className="p-1 text-left text-xs font-medium md:text-lg">Υποχρεωτικά</th>
                      <th className="p-1 text-left text-xs font-medium md:text-lg">Bασικά</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr
                      className={`${s1YPassed >= 2 && s1BPassed >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                    ...
                    <tr
                      className={`${s2YPassed >= 2 && s2BPassed >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                    ...
                    <tr
                      className={`${s3YPassed >= 2 && s3BPassed >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                    ...
                    <tr
                      className={`${s4YPassed >= 2 && s4BPassed >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                    ...
                    <tr
                      className={`${s5YPassed >= 2 && s5BPassed >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                    ...
                    <tr
                      className={`${s6YPassed >= 2 && s6BPassed >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
            ...
            <div className="pt-4">
              <h3 className="mb-5 text-xl font-bold">Planned Overview</h3>
              <div className={`mb-4 ${ectsPlannedSum >= 240 ? 'text-green-300' : ''}`}>
                <div
                  className={`text-sm font-medium ${ectsPlannedSum >= 240 ? 'text-green-300' : 'text-muted-foreground'}`}
                >
                  Planned ECTS
                </div>
              ...
              <div className={`mb-4 ${gpPlanned === 3 ? 'text-green-300' : ''}`}>
                <div
                  className={`text-sm font-medium ${gpPlanned === 3 ? 'text-green-300' : 'text-muted-foreground'}`}
                >
                  Planned Γενικης Παιδειας
                </div>
              ...
              <div className={`mb-4 ${ypPlanned === 18 ? 'text-green-300' : ''}`}>
                <div
                  className={`text-sm font-medium ${ypPlanned === 18 ? 'text-green-300' : 'text-muted-foreground'}`}
                >
                  Planned Υποχρεωτικά
                </div>
              ...
              <div className="w-full overflow-x-auto">
                <table className="w-full border-collapse">
                  ...
                  <tbody>
                    <tr
                      className={`${s1YPlanned >= 2 && s1BPlanned >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                      <td className="p-1">S1</td>
                    ...
                    <tr
                      className={`${s2YPlanned >= 2 && s2BPlanned >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                      <td className="p-1">S2</td>
                    ...
                    <tr
                      className={`${s3YPlanned >= 2 && s3BPlanned >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                      <td className="p-1">S3</td>
                    ...
                    <tr
                      className={`${s4YPlanned >= 2 && s4BPlanned >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                      <td className="p-1">S4</td>
                    ...
                    <tr
                      className={`${s5YPlanned >= 2 && s5BPlanned >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                      <td className="p-1">S5</td>
                    ...
                    <tr
                      className={`${s6YPlanned >= 2 && s6BPlanned >= 4 ? 'bg-green-300 text-green-900' : ''}`}
                    >
                      <td className="p-1">S6</td>
